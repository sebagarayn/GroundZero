...
/* Interfaz para representar una entidad que puede ser objetivo
 * de enemigos. Las entidades que la implementen puede ser perseguida
 * por enemigos que requieran de un objetivo*/
